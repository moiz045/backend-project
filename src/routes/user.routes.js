...
router
  ...
  .post(authenticateUser, addToWatchHistory);
router.route("/watch-later").get(authenticateUser, getWatchLater);
router.route("/watch-later/:videoId").patch(authenticateUser, toggleWatchLater);
